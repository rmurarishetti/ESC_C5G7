        ...
        dropdown.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if (position==1){
                    ...
                    adapter = ArrayAdapter
                            .createFromResource(getApplicationContext(), R.array.china_document_type,
                                    android.R.layout.simple_spinner_item);
                }
                else if (position==4){
                    adapter = ArrayAdapter
                            .createFromResource(getApplicationContext(), R.array.eu_document_type,
                                    android.R.layout.simple_spinner_item);
                }
                else if (position==5){
                    adapter = ArrayAdapter
                            .createFromResource(getApplicationContext(), R.array.usa_document_type,
                                    android.R.layout.simple_spinner_item);
                }
                if (adapter!=null){

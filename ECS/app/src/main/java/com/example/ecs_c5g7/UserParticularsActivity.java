    ...
    private void submitParticulars() {
        ...
        firestore.collection("Particulars").document(mAuth.getCurrentUser().getUid()).set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                startActivity(new Intent(UserParticularsActivity.this, HomeActivity.class));
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UserParticularsActivity.this, "Particulars Upload Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }

...
public class PendingCustomersActivity extends AppCompatActivity {
    ...
    ArrayList<UserModel> pendingUserArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_customers);
            ...
            FirebaseDatabase.getInstance().getReference().child(userModelArrayList.get(i).getUserId()).child("docs")
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (tempIsPending) {
                                pendingUserArrayList.add(userModelArrayList.get(finalI));
                            }
